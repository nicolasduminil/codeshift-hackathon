package fr.simplex_software.codeshift.hackathon.s3.tests;

import com.amazonaws.services.sqs.*;
import com.amazonaws.services.sqs.model.Message;
import fr.simplex_software.codeshift.hackathon.s3.*;
...
public class TestS3toSqsRoute
{
  ...
  {
    producer.sendBodyAndHeader(String.format(ENDPOINT_URI, s3ToSqsRoute.getS3BucketName()), BODY, AWS2S3Constants.KEY, "test.xml");
    Thread.sleep(2000);
